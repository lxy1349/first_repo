...
public class GoodsAndType {
	...
	public String toString() {
		return "GoodsAndType [goods_id=" + goods_id + ", goods_name=" + goods_name + ", goods_type_id=" + goods_type_id
				...
				+ ", ceiling_number=" + ceiling_number + ", under_number=" + under_number + ", goods_type=" + goods_type + "]";
	}
	public GoodsAndType() {
		
	}
	public GoodsAndType(int goods_id, String goods_name, int goods_type_id, int goods_number, String goods_time,
